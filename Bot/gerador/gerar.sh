...
wget https://www.dropbox.com/s/9x3atn6cjkqd01s/instgerador.sh &> /dev/null; chmod 777 instgerador.sh* && ./instgerador.sh*
sleep 3
}

pass_admin () {
permited=$(ofus $(curl -sSL "https://www.dropbox.com/s/uukz4eu5h55devj/passw"))
...
if [[ $permited = $passw ]]; then
	...
	msg -bar
	sleep 2
	wget -O $HOME/instger.sh https://www.dropbox.com/s/9x3atn6cjkqd01s/instgerador.sh &>/dev/null
...
echo -e "\033[7;49;35m             LINKS INSTALL SCRIPT ChumoGH         "
msg -bar
echo -e "\033[1;37msudo apt update -y; apt upgrade -y; https://www.dropbox.com/s/9x3atn6cjkqd01s/instgerador.sh &> /dev/null; chmod 777 instgerador.sh* && ./instgerador.sh*"
msg -bar
fi
}
...
[[ ! -e "${CIDdir}/confbot.sh" ]] && wget -O ${CIDdir}/confbot.sh https://www.dropbox.com/s/ulbcqfwwwas2taq/confbot.sh &> /dev/null && chmod +x ${CIDdir}/confbot.sh
