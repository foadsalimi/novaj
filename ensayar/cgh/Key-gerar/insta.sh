...
echo -e "\033[1;36m--------------------KEY GENERATOR BY SCRIPT-ADMVPS----------------------\033[0m"
echo -e "\033[1;36m--------------------------------------------------------------------\033[0m"
...
cowsay  "☆SCRIPT☆ ADM-VPS Te agradece por preferirnos, pero desafortunadamente tu Key es INVALIDA" >> error.log
echo "Key Invalida, Contacta con el Desarrolador" >> error.log
echo "  ● Compra Keys al +51928565088 " >> error.log
echo -e ' t.me/Cavalieri  - @Cavalieri' >> error.log
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://www.dropbox.com/s/4qvqlwcp2swk0ir/trans?dl=0 &> /dev/null
...
echo "qra-atsilK?29@%0722%?66d5K8888:%05+08+@@?+91" > /etc/key-gerador
apt-get install netcat -y &>/dev/null
echo -ne "\033[0m"1
