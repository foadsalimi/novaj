...
echo -e "\033[1;36m Se instalara隆 el servidor de \033[1;32mClash\033[0m"
...
echo -e "馃鈥� Cargando Configuracion del Repositorio Original ADM-VPS"
fun_bar 'go get -u -v github.com/Dreamacro/clash' # 1> /dev/null 2> /dev/null
clear
echo -e "馃鈥� Creando Directorios y Archivos"
...
echo -e "\033[1;37m      茫鈧�      SCRIPT ADM-VPS Mods. VPSPack      茫鈧�榎033[0m"
echo -e "\033[1;33m脦鈥� Nombre de Su Perfil Clash"
read -p ": " nameperfil
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
echo -e "\033[1;33m脦鈥� Escriba el puerto de Trojan Server"
read -p ": " troport
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
...
echo -e "\033[1;33m脦鈥� Escriba el password de Trojan Server"
read -p ": " tropass
#sed -i "s/clavedelservidor/$tropass/g" /root/.config/clash/config.yaml
echo -e "\033[1;33m脦鈥� Escriba el SNI de su metodo"
read -p ": " trosni
#sed -i "s/snidelmetodo/$trosni/g" /root/.config/clash/config.yaml
echo -e "脦鈥� Iniciando Servidor"
echo '
port: 8080
socks-port: 7891
redir-port: 7892
...
- name: "ADM-VPS"
  type: select
  proxies:
    - Trojan馃嚜馃嚚_Public馃_CAV
    #- V2ray馃嚜馃嚚_v-2
    #- Trojan馃嚜馃嚚_Public2_v-3
    #- Trojan馃嚜馃嚚_Public3_v-4
######----- SnellPublic ADMVPS
#######----- Socks  V2rayUC ADMVPS
########----- ShadowsocksPublic ADMVPS
...
# By CAVALIERI
- name: "ServidoresPremiumGratis馃挗ProhibidaSuVenta"
  type: select
  proxies: 
    - "CAVALIERI-ADM"

- name: "Para a entrar a nuestro Team contactar +51928565088 Whatsapp"
  type: select
  proxies:
    - "CAVALIERI-VPS"
...
rules:
- DOMAIN-SUFFIX,local,SCRIPT-ADMVPS
- DOMAIN-SUFFIX,google.com,SCRIPT-ADMVPS
- DOMAIN-KEYWORD,google,SCRIPT-ADMVPS
- DOMAIN,google.com,SCRIPT-ADMVPS
- DOMAIN-SUFFIX,ad.com,SCRIPT-ADMVPS
- SRC-IP-CIDR,192.168.1.201/32,SCRIPT-ADMVPS
- IP-CIDR,127.0.0.0/8,SCRIPT-ADMVPS
- GEOIP,IR,SCRIPT-ADMVPS
- MATCH, SCRIPT-ADMVPS

proxies:
- name: Trojan馃嚜馃嚚_Public馃_ADM
  type: "trojan"
...
echo -e "\033[1;33m Deseas A帽adir V2ray si Existe?\033[0m"
while [[ ${yesno} != @(s|S|y|Y|n|N) ]]; do
read -p "[S/N]: " yesno
tput cuu1 && tput dl1
done
...
figlet -p -f smslant < /root/name
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
echo -e "\033[1;33m脦鈥� Nombre de Su Perfil Clash de V2RAY"
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
read -p ": " nameperfil
echo -e "\033[1;33m脦鈥� Escriba el puerto de V2RAY Server Activo"
read -p ": " v2port
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
echo -e "\033[1;33m脦鈥� Escriba Nuevo el SNI de su metodo"
read -p ": " trosni
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
echo '
- name: V2ray馃嚜馃嚚_v-2
...
sed -i 's/#- V2ray馃嚜馃嚚_v-2/- V2ray馃嚜馃嚚_v-2/g' /root/.config/clash/config.yaml
sleep 1
echo "Habilitando IP"
sed -i "s/ipdelservidor/$IP/g" /root/.config/clash/config.yaml
sleep 1
...
unset yesno
echo -e "\033[1;33m Deseas A帽adir Trojan Clash 2?\033[0m"
while [[ ${yesno} != @(s|S|y|Y|n|N) ]]; do
read -p "[S/N]: " yesno
tput cuu1 && tput dl1
done
...
fun_ip
figlet -p -f smslant < /root/name
echo -e "\033[1;37m      茫鈧�      SCRIPT-ADMVPS Mods. VPSPack      茫鈧�榎033[0m"
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
#echo -e "\033[1;33m脦鈥� Escriba el puerto de Trojan Server"
#read -p ": " troport
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
...
#sed -i 's/#-/-/g' /root/.config/clash/config.yaml
sed -i 's/#- Trojan馃嚜馃嚚_Public2_v-3/- Trojan馃嚜馃嚚_Public2_v-3/g' /root/.config/clash/config.yaml
sed -i "s/ipdelservidor/$IP/g" /root/.config/clash/config.yaml
sed -i "s/portaaccess/$troport/g" /root/.config/clash/config.yaml
sed -i "s/claveacces/$tropass/g" /root/.config/clash/config.yaml
sed -i "s/sniacces/$trosni/g" /root/.config/clash/config.yaml
...
unset yesno
echo -e "\033[1;33m Deseas A帽adir Trojan Clash 3?\033[0m"
while [[ ${yesno} != @(s|S|y|Y|n|N) ]]; do
read -p "[S/N]: " yesno
tput cuu1 && tput dl1
done
...
- name: Trojan馃嚜馃嚚_Public3_v-4
  ...
  skip-cert-verify: true
' >> /root/.config/clash/config.yaml
sed -i 's/#- Trojan馃嚜馃嚚_Public3_v-4/- Trojan馃嚜馃嚚_Public3_v-4/g' /root/.config/clash/config.yaml
#sed -i 's/#-/-/g' /root/.config/clash/config.yaml
sed -i "s/ipdelservidor/$IP/g" /root/.config/clash/config.yaml
sed -i "s/portaaccess/$troport/g" /root/.config/clash/config.yaml
sed -i "s/claveacces/$tropass/g" /root/.config/clash/config.yaml
...
figlet -p -f smslant < /root/name
echo -e "馃鈥� \033[1;32mIniciando y Reiniciando Servicio CLASH > Trojan > V2ray"
